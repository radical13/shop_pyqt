...
class Ui_input(object):
    def setupUi(self, input):
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 180, 60, 30))
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 130, 60, 30))
    ...
    def retranslateUi(self, input):
        ...
        self.label_3.setText(_translate("input", "商品单价"))
        self.label.setText(_translate("input", "商品ID"))
        self.label_2.setText(_translate("input", "商品名称"))
